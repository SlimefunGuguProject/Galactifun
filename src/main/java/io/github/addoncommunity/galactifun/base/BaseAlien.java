...
public final class BaseAlien {
    ...
    public static final Firestorm FIRESTORM = new Firestorm("FIRESTORM", "火爆", 40, 10);
    public static final MutantCreeper MUTANT_CREEPER = new MutantCreeper("MUTANT_CREEPER", "变异爬行者", 40, 5);
